    ...
    scheduleItems: [
      {
        ...
        time: '7:00',
        description:
          "According to chronobiologists (specialists in the study of the body's physiological rhythms), our internal alarm clocks are programmed to go off after seven to eight hours sleep, which means I, like most people, get a biological wake-up call at around 7am."
      },
      {
        name: 'Eat Breakfast',
        time: '9:25',
        description:
          'Studies at the University of Leeds by Professor John Blundell have shown that people who eat a breakfast that is high in carbohydrate and low in fat are less likely to binge on high-calories foods later in the day.'
      },
      {
        name: 'Take light lunch',
        time: '12:20',
        description:
          "The body's digestive processes reach top speed at around midday, so now is the time to stop for a light meal."
      },
      {
        name: 'Work out',
        time: '17:15',
        description:
          'It is no coincidence that many Olympic records are broken at around this time - in fact, very few have ever been set before noon.'
      },
      {
        name: 'Dinner',
        time: '18:00',
      ...
      },
      {
        ...
        time: '22:15',
        description:
          'Between 10pm and 11pm is said to be the best time to go to bed.\n' +
  ...
  },
  {
    ...
    scheduleItems: [
      ...
      },
      {
        ...
        time: '6:30',
        description:
          'It can be easier to stick with a morning exercise routine because the timing is less likely to conflict with other responsibilities'
      },
      {
        name: 'Coffee Break',
        time: '10:00',
        description:
          'Aim for mid morning to optimize productivity. Coffee is most effective between 9am and 10:30am when cortisol (a natural hormone that regulates energy) levels are lower.'
      },
      {
        name: 'Eat lunch',
        time: '12:00',
      ...
      },
      {
        ...
        time: '20:00',
        description:
          'If you have a side project or artistic hobby, the late evening is a good time for creativity, as fatigue lowers inhibitions and opens you up to unusual ideas.'
      },
      {
        name: 'Going to sleep',
        time: '21:30',
  ...
  },
  {
    ...
    scheduleItems: [
      ...
      },
      {
        ...
        time: '18:00',
        description:
          "This is when reaction time is quickest, blood pressure and heart rate are lowest, and body temperature is almost at its peak. Be sure to eat a snack before the workout if you haven't eaten since lunch."
      },
      {
        name: 'Eat dinner',
        time: '20:30',
